    ...
    switch(opcion)
     {
       case 1: p=leer_persona();
               if (insertar_persona(agenda,MAX_AGEN,p)==1)
                 printf("\n nuevo contacto introducido con exito");
               else  
                 printf("\nError, el contacto no se ha podido introducir");
               break;
       ...
       case 3: listar_agenda(agenda,MAX_AGEN);
               break;
       case 4: printf("\nIntroduce el nombre del contacto que desea borrar: ");
               gets(nombre);
